    ...
    <div className="max-w-md mx-auto mt-16 px-4">
      <div className="bg-white p-6 md:p-10 rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-gray-200/50">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500">Log in to your private sanctuary.</p>
        </div>
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          Don't have an account? <Link to="/signup" className="text-[#2D5A27] font-bold hover:underline">Create one</Link>
        </div>
      </div>
    </div>
  );
